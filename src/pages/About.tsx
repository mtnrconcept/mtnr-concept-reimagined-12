...
const About = () => (
  <div className="relative z-10">
    <Navbar />
    <main className="pt-36 pb-24 min-h-screen max-w-3xl mx-auto rounded-3xl shadow-xl my-8 px-7">
      <h1 className="font-playfair text-4xl md:text-5xl font-bold mb-4 text-center text-yellow-400 uppercase">À propos</h1>
      <div className="flex flex-col md:flex-row items-center gap-10 mt-7">
        ...
        <div>
          <h2 className="font-playfair text-2xl font-bold mb-2 text-gray-100">MTNR Concept</h2>
          <p className="font-inter text-gray-200 text-lg mb-4">
          ...
          <p className="font-inter text-gray-200 text-lg">
