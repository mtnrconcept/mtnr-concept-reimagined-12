                  ...
                  <TabsContent value="infos" className="mt-0">
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField control={form.control} name="blaze" render={({ field }) => 
                          <FormItem>
                    ...
                    <div className="space-y-6">
                      {watchService === "recording" && 
                        <FormField control={form.control} name="trackCount" render={({ field }) => 
                          <FormItem>
                            <FormLabel className="text-yellow-400 flex items-center gap-2">
                              <span>Nombre de morceaux à enregistrer</span>
                            </FormLabel>
                            <FormControl>
                              <Input 
                                type="number" 
                      ...
                      <FormField 
                        ...
                        render={() => 
                          <FormItem>
                            <div className="mb-4">
                              <FormLabel className="text-yellow-400 flex items-center gap-2">Services supplémentaires</FormLabel>
                      ...
                      <div className="flex flex-col xs:flex-row gap-4 pt-4">
                        <Button 
                          ...
                          className="relative overflow-hidden group hover:text-yellow-400 border border-yellow-400/70 font-bold py-4 xs:flex-1"
                        >
                        ...
                        <Button 
                          type="submit" 
                          className="relative overflow-hidden group hover:text-black font-black tracking-wider py-4 xs:flex-1"
                        >
                          <span className="absolute inset-0 bg-[#D2FF3F] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300 z-0"></span>
