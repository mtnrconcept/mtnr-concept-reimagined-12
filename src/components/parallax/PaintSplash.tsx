...
export const PaintSplash: FC<PaintSplashProps> = ({
  x,
  y,
  depth,
  scale = 1,
  ...
  return (
    <div
      ...
      data-parallax
      data-depth={depth}
      data-parallax-depth={depth * 0.5}
      style={{
        left: `${x}%`,
        top: `${y}%`,
        mixBlendMode: finalBlendMode,
        zIndex,
        transform: `translate(-50%, calc(-50% + var(--wc-parallax-offset, 0px))) scale(${finalScale}) rotate(${rotation}deg)`,
