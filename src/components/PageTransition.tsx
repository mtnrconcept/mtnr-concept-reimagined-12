...
-  // Pour passer la route précédente au DispersingLogo
...
+  const [triggerLogoDispersion, setTriggerLogoDispersion] = useState(false);
   ...
   useEffect(() => {
     ...
     // MàJ pour le prochain changement de route
     prevPathRef.current = location.pathname;
     ...
     <>
       <DispersingLogo
         ...
         onDispersionComplete={() => {
           /* si tu veux synchroniser autre chose */
         }}
