...
export default function ServicesSection() {
  return (
    <section data-animate className="container mx-auto py-16 px-4 sm:px-6 backdrop-blur-sm rounded-3xl my-16 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {['Studio', 'Mix', 'Mastering'].map((service, index) => (
          <div 
            key={service} 
            className="relative overflow-hidden backdrop-blur-xl bg-black/70 rounded-xl border border-yellow-400/30 p-6 sm:p-8 text-center group hover:shadow-[0_0_25px_rgba(255,215,0,0.15)] transition-all duration-500 hover:-translate-y-2"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <Link 
                to="/book" 
                className="inline-block px-6 py-2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-bold uppercase tracking-wider rounded-lg shadow-lg hover:shadow-[0_0_15px_rgba(255,215,0,0.2)] hover:from-yellow-300 hover:to-yellow-400 transition-all duration-300"
              >
