...
export default function HeroSection() {
  return <section id="hero-section" className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      ...
      <div className="relative overflow-hidden mt-8 w-full max-w-3xl mx-auto backdrop-blur-xl bg-black/50 border border-yellow-400/30 shadow-[0_0_25px_rgba(255,215,0,0.15)] rounded-2xl p-8 sm:p-10" data-animate>
        ...
        <div className="mt-10 flex flex-wrap gap-4 justify-center">
          <Link to="/what-we-do" className="relative px-8 py-3 bg-yellow-400 text-black font-bold rounded-lg overflow-hidden group hover:shadow-[0_0_20px_rgba(255,215,0,0.3)] transition-all duration-300">
          ...
          <Link to="/contact" className="px-8 py-3 bg-black/60 border border-yellow-400/50 text-white font-bold rounded-lg shadow-lg hover:shadow-[0_0_15px_rgba(255,215,0,0.2)] hover:bg-black/80 hover:border-yellow-400 transition-all duration-300">
            Contactez-nous
          </Link>
        </div>
      </div>
