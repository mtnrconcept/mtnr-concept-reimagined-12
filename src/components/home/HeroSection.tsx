...
export default function HeroSection() {
  return <section id="hero-section" className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      ...
      <div data-animate className="relative overflow-hidden mt-8 w-full max-w-3xl backdrop-blur-xl bg-black/70 border border-yellow-400/30 shadow-[0_0_25px_rgba(255,215,0,0.15)] rounded-2xl p-8 sm:p-10 px-[25px] mx-0 py-[25px]">
        ...
        <h1 className="font-display text-4xl sm:text-5xl md:text-7xl text-yellow-400 mb-6 neon-text uppercase tracking-tighter drop-shadow-[0_0_8px_rgba(255,215,0,0.3)] mx-0 px-0">
          <span className="block text-center font-thin text-8xl my-0 mx-[24px] px-0">BIENVENUE au</span>
          <span className="block mt-2 text-center font-normal text-6xl mx-0 px-0">MTNR CONCEPT STUDIO</span>
        </h1>
