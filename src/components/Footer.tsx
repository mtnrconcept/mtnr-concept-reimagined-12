      ...
      <div className="container mx-auto py-0 my-0 rounded-full px-[62px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <span className="font-playfair text-xl font-bold mt-2 my-0">
          </span>
            <p className="text-sm text-gray-400 mt-2 my-0">© {new Date().getFullYear()} MTNR Concept. Tous droits réservés.</p>
          </div>
          
          {/* Colonne des liens de navigation */}
          <div className="flex flex-col gap-2 text-center md:text-center py-0 my-0 px-[31px] mx-0">
